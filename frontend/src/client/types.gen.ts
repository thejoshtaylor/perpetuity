...
export type _WorkflowCreateBody = {
    name: string;
    ...
    steps?: Array<_WorkflowStepCreateBody>;
};

export type _WorkflowStepCreateBody = {
    step_index: number;
    action: string;
    config?: {
        [key: string]: unknown;
...
export type _WorkflowUpdateBody = {
    name?: (string | null);
    description?: (string | null);
    scope?: (string | null);
    target_user_id?: (string | null);
    ...
    steps?: (Array<_WorkflowStepCreateBody> | null);
};

export type Body_voice_transcribe_voice = {
    file: (Blob | File);
};
...
export type WorkflowAction = 'claude' | 'codex' | 'shell' | 'git';
...
export type WorkflowStepPublic = {
    ...
    target_container?: WorkflowStepTargetContainer;
    created_at?: (string | null);
    updated_at?: (string | null);
};

export type WorkflowStepTargetContainer = 'user_workspace' | 'team_mirror';

export type WorkflowWithStepsPublic = {
    id: string;
    team_id: string;
    name: string;
    description?: (string | null);
...
export type VoiceTranscribeVoiceData = {
    formData: Body_voice_transcribe_voice;
};
...
export type WorkflowsCreateWorkflowData = {
    requestBody: _WorkflowCreateBody;
    teamId: string;
};

export type WorkflowsCreateWorkflowResponse = (WorkflowWithStepsPublic);

export type WorkflowsGetWorkflowData = {
    workflowId: string;
};

export type WorkflowsGetWorkflowResponse = (WorkflowWithStepsPublic);

export type WorkflowsUpdateWorkflowData = {
    requestBody: _WorkflowUpdateBody;
    workflowId: string;
};

export type WorkflowsUpdateWorkflowResponse = (WorkflowWithStepsPublic);
...
export type WorkflowsCancelWorkflowRunData = {
    runId: string;
};

export type WorkflowsCancelWorkflowRunResponse = ({
    [key: string]: (string);
});